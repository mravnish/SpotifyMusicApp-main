...
//         }
//         // new add this statement
//         else {
//             console.log("No previous Song")
//             playMusic(songs[index])
//             // alert("No previous Song. Please Press the new tab")
//             ///////////////////////////////
//             // Create a notification element
//             let notification = document.createElement("div");
//             notification.className = "notification";
//             notification.textContent = "No Previous Song !";
...
//             playMusic(songs[index])
//             // alert("No next Song. Please Press the new tab")
//             ///////////////////////////////
//             // Create a notification element
//             let notification = document.createElement("div");
//             notification.className = "notification";
//             notification.textContent = "No Next Song, Tab Other Card!";
//             // Append the notification to the body
//             document.body.appendChild(notification);
//             // Remove the notification after 3 seconds
//             setTimeout(function () {
...
//     let a = await fetch(`/songs/`)
//     let response = await a.text();
//     console.log("rrrrrrrrrrrrrrrrrrrrrrrrrr", a)
//     let div = document.createElement("div")
//     div.innerHTML = response;
//     let anchors = div.getElementsByTagName("a")
//     let cardContainer = document.querySelector(".cardContainer")
...
//             // let folder = e.href.split("/").slice(-2)[0];
//             let folder = e.href;
//             console.log("fffffffffffffffffffff", folder)
//             // let metadata = await fetch(`/songs/${folder}/info.json`).then(res => res.json()).catch(err => {
...
//                 return {};
//             });
//             console.log("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", metadata)
...
//             card.addEventListener("click", async () => {
//                 console.log("Fetching Songs");
//                 songs = await getSongs(folder.replace("http//", "http://")); // Fix malformed URLs
//                 ;
